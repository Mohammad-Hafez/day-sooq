...
export default function SideMenu({setCategory , setMaxPrice , setMinPrice , maxPrice , minPrice , SelectedColors , setSelectedColors ,setIsUsed, setSize}) {
  return <>
