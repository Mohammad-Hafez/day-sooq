  ...
  <div className="container login w-75 ">
      ...
      <div className="row">
          <div className="col-12 text-start">
            <label className='ms-2' htmlFor="currentPassword">current Password</label>
            <input type="password"  placeholder='currentPassword' className='AuthForm-inputs mb-2 form-control' name='currentPassword' id='currentPassword' value={formik.values.currentPassword} onChange={formik.handleChange} onBlur={formik.handleBlur}/>
        ...
        <div className="btns col-12 my-2">
          ...
          :<>
          <button type="submit" disabled={!(formik.isValid && formik.dirty)} className='btn btn-orange rounded-pill text-light me-2 w-100 d-flex align-items-center justify-content-center'><span className='me-2'>Change Password</span><Icon className='pb-1' size={20}  icon={login}></Icon></button>
          </>
          }
        </div>
        <div className="col-12">
