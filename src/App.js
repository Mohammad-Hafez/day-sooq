...
import { messaging, generateToken, initMessaging } from './notifications/firebase';
    ...
    <PrimeReactProvider>
      <CartContextProvider>
        <WishListContextProvider>
          <Offline>
            <div className='network p-3 bg-danger text-light rounded align-items-center d-flex position-absolute bottom-0 start-0 m-4'>
              <Icon icon={wifiOff} className='me-2'></Icon> Failed Network Connection
            </div>
          </Offline>
          <Toaster />
          <Router>
